...
// Source: github.com/lfvm/simplebank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) GetAccountForUpdates(arg0 context.Context, arg1 int64) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountForUpdates", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetAccountForUpdates(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountForUpdates", reflect.TypeOf((*MockStore)(nil).GetAccountForUpdates), arg0, arg1)
}
...
func (m *MockStore) ListEntries(arg0 context.Context, arg1 db.ListEntriesParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) TransferTransaction(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
